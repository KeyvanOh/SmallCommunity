...
public class Const {
    ...
    //public static final double aMax = 1.;
    public static final double A_MAX = 1.;
    //public static final double aShadow = 0.7;
    //public static final double aShadow = 0.6;
    public static final double A_SHADOW = 0.6;
